      ...
      <div className="px-6 pb-32 pt-2">
        ...
        {quickPlayItems.length > 0 && (
          <motion.div
            ...
            className="grid grid-cols-2 lg:grid-cols-3 gap-2 mb-8"
          >
            {quickPlayItems.map((track, index) => (
              ...
              >
                ...
                <span className="px-3 font-medium text-sm truncate flex-1 text-left">
                  {track.title}
                </span>
                <div className="w-10 h-10 rounded-full bg-primary text-primary-foreground items-center justify-center mr-2 hidden group-hover:flex shadow-lg shadow-primary/30">
                ...
                >
                  <div className="relative aspect-square rounded-md mb-4 bg-secondary overflow-hidden shadow-lg">
                    ...
                    <div className="absolute bottom-2 right-2 opacity-0 translate-y-2 group-hover:opacity-100 group-hover:translate-y-0 transition-all">
                      <div className="w-12 h-12 rounded-full bg-primary text-primary-foreground flex items-center justify-center shadow-xl shadow-black/30">
