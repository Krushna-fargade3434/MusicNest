    ...
    <header className="sticky top-0 z-30 flex items-center justify-between px-6 py-4 bg-gradient-to-b from-background/80 via-background/60 to-transparent backdrop-blur-md">
      ...
      <div className="flex items-center gap-4">
        ...
        <div className="md:hidden flex items-center gap-2">
           <img src="/MUSIC-NEST-LOGO.png" alt="Music Nest" className="w-8 h-8 object-cover rounded-full" />
           <span className="text-lg font-bold text-gradient">MusicNest</span>
        </div>
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className={cn(
            'flex items-center gap-2 p-0.5 pr-3 rounded-full bg-black/60 hover:bg-black/80 transition-colors',
            currentUser ? '' : 'pr-0.5'
          )}
        >
          <div
